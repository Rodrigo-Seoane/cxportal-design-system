        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px', flex: 1, padding: '0 4px' }}>
          ...
          <div
            style={{
              ...
              height: 12,
              flexShrink: 0,
              background: selected ? T.surfaceCheckbox : 'var(--neutral-0)',
              border: `1px solid ${T.borderCheckbox}`,
              borderRadius: '2px',
              display: 'flex',
              alignItems: 'center',
